...
function showHand(hand, elementId) {
  ...
  for (let i in hand) {
    let card = $('<div class="card"><img src="images/' + hand[i] + '.png" alt="' + hand[i] + '" class="w-100"></div>');
    $(div).append(card);
  }
...
function showConcealed() {
  ...
  for (let i in dealerHand) {
    if (i == 0) {
      card = $('<div class="card"><img src="images/cardBack.png" alt="face down card" class="w-100"></div>');
    } else {
      card = $('<div class="card"><img src="images/' + dealerHand[i] + '.png" alt="' + dealerHand[i] + '" class="w-100"></div>');
    }
    $(div).append(card);
  }
